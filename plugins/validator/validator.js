class Validator{
  ...
  isValid(elem){
    ...
    if (this.method) {
      ...
      if (method) {
        ...
        console.warn('Необходимо передать id полей ввода и методы для проверки этих полей!')
      }
  ...
  this.pattern.ruText = this.pattern.ruText ? this.pattern.ruText : /^[а-яё][0-9]$/gi;
  }
}